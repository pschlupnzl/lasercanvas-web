window.LaserCanvas.Sellmeier.refractiveIndex = [{
   ...
   "comments": "Synthetic sapphire, Extraordinary ray (e), 20 øC",
   "formula": 1,
   "range": [0.2, 5],
...
},
{
   ...
   "comments": "Synthetic sapphire, Ordinary ray (o), 20 øC",
   "formula": 1,
   "range": [0.2, 5],
   "references": "1) I. H. Malitson and M. J. Dodge. Refractive Index and Birefringence of Synthetic Sapphire, <a href=\"http://www.opticsinfobase.org/josa/abstract.cfm?uri=josa-62-11-1336\"><i>J. Opt. Soc. Am.</i> <b>62</b>, 1405 (1972)</a><br>2) M. J. Dodge, \"Refractive Index\" in Handbook of Laser Science and Technology, Volume IV, Optical Materials: Part 2, CRC Press, Boca Raton, 1986, p. 30<br>* Ref. 1 is a talk abstract in a conference program; Ref. 2 provides Sellmeier equation",
   "source": "Malitson-o"
},
{
   ...
   "comments": "Synthetic sapphire, Ordinary ray (o), 24 øC",
   "formula": 1,
   "range": [0.2652, 5.577],
...
},
{
   ...
   "comments": "Beta barium borate (á-BaB<sub>2</sub>O<sub>4</sub>, BBO). Extraordinary ray (e).",
   "formula": 4,
   "range": [0.22, 1.06],
...
},
{
   ...
   "comments": "Beta barium borate (á-BaB<sub>2</sub>O<sub>4</sub>, BBO). Ordinary ray (o).",
   "formula": 4,
   "range": [0.22, 1.06],
   "references": "D. Eimerl, L. Davis, S. Velsko, E. K. Graham and A. Zalkin. Optical, mechanical, and thermal properties of barium borate , <a href=\"https://doi.org/10.1063/1.339536\"><i>J. Appl. Phys.</i>, <b>62</b>, 1968-1983 (1987)</a>",
   "source": "Eimerl-o"
},
{
   ...
   "comments": "Beta barium borate (á-BaB<sub>2</sub>O<sub>4</sub>, BBO). Extraordinary ray (e). Near infrared.",
   "formula": 4,
   "range": [0.64, 3.18],
...
},
{
   ...
   "comments": "Beta barium borate (á-BaB<sub>2</sub>O<sub>4</sub>, BBO). Ordinary ray (o). Near infrared.",
   "formula": 4,
   "range": [0.64, 3.18],
   "references": "D. Zhang, Y. Kong, J.-Y. Zhang. Optical parametric properties of 532-nm-pumped beta-barium-borate near the infrared absorption edge, <a href=\"https://doi.org/10.1016/S0030-4018(00)00968-8\"><i>Optics Communications</i>, <b>184</b>, 485-491 (2000)</a>",
   "source": "Zhang-o"
...
},
{
   ...
   "comments": "20 øC, Nitrogen atmosphere",
   "formula": 2,
   "range": [0.138, 2.326],
...
},
{
   ...
   "comments": "25 øC, Nitrogen atmosphere",
   "formula": 2,
   "range": [0.138, 2.326],
   "references": "M. Daimon and A. Masumura. High-accuracy measurements of the refractive index and its temperature coefficient of calcium fluoride in a wide wavelength range from 138 to 2326 nm, <a href=\"https://doi.org/10.1364/AO.41.005275\"><i>Appl. Opt.</i> <b>41</b>, 5275-5281 (2002)</a>",
   "source": "Daimon-25"
...
},
{
   ...
   "comments": "21 øC. Extraordinary ray (e). Congruently grown lithium niobate.",
   "formula": 2,
   "range": [0.4, 5],
...
},
{
   ...
   "comments": "21 øC. Ordinary ray (o). Congruently grown lithium niobate.",
   "formula": 2,
   "range": [0.4, 5],
   "references": "D. E. Zelmon, D. L. Small, and D. Jundt. Infrared corrected Sellmeier coefficients for congruently grown lithium niobate and 5 mol.% magnesium oxide-doped lithium niobate, <a href=\"https://doi.org/10.1364/JOSAB.14.003319\"><i>J. Opt. Soc. Am. B</i> <b>14</b>, 3319-3322 (1997)</a>",
   "source": "Zelmon-o"
},
{
   ...
   "comments": "19 øC. Extraordinary ray (e).",
   "formula": 1,
   "range": [0.2, 7],
...
},
{
   ...
   "comments": "293 K (20 øC). Extraordinary ray (e).",
   "formula": 1,
   "range": [0.14, 7.5],
   "references": "H. H. Li. Refractive index of alkaline earth halides and its wavelength and temperature derivatives. <a href=\"https://doi.org/10.1063/1.555616\"><i>J. Phys. Chem. Ref. Data</i> <b>9</b>, 161-289 (1980)</a> and references therein.<br> <sup>*</sup> Sellmeier formula is derived by critical analysis of experimental data from several sources.",
   "source": "Li-e"
},
{
   ...
   "comments": "293 K (20 øC). Ordinary ray (o).",
   "formula": 1,
   "range": [0.14, 7.5],
   "references": "H. H. Li. Refractive index of alkaline earth halides and its wavelength and temperature derivatives. <a href=\"https://doi.org/10.1063/1.555616\"><i>J. Phys. Chem. Ref. Data</i> <b>9</b>, 161-289 (1980)</a> and references therein.<br> <sup>*</sup> Sellmeier formula is derived by critical analysis of experimental data from several sources.",
   "source": "Li-o"
...
},
{
   ...
   "comments": "n<sub>à</sub>; 293 K (20 øC).",
   "formula": 4,
   "range": [0.4, 1.5],
   "references": "J. J. Carvajal, P. Segonds, A. Pe¤a, J. Zaccaro, B. Boulanger, F. D¡az and M. Aguil¢. Structural and optical properties of RbTiOPO<sub>4</sub>:Nb crystals , <a href=\"https://doi.org/10.1088/0953-8984/19/11/116214\"><i>J. Phys.: Condens. Matter</i> <b>19</b>, 116214, 2007</a>",
   "source": "Carvajal-alpha"
},
{
   "book": "RbTiOPO4",
   "coefficients": [2.036, 1.0883, 2, 0.0437, 1, 0, 0, 0, 1],
   "comments": "n<sub>á</sub>; 293 K (20 øC).",
   "formula": 4,
   "range": [0.4, 1.5],
   "references": "J. J. Carvajal, P. Segonds, A. Pe¤a, J. Zaccaro, B. Boulanger, F. D¡az and M. Aguil¢. Structural and optical properties of RbTiOPO<sub>4</sub>:Nb crystals , <a href=\"https://doi.org/10.1088/0953-8984/19/11/116214\"><i>J. Phys.: Condens. Matter</i> <b>19</b>, 116214, 2007</a>",
...
},
{
   ...
   "comments": "n<sub>?</sub>; 293 K (20 øC).",
   "formula": 4,
   "range": [0.4, 1.5],
   "references": "J. J. Carvajal, P. Segonds, A. Pe¤a, J. Zaccaro, B. Boulanger, F. D¡az and M. Aguil¢. Structural and optical properties of RbTiOPO<sub>4</sub>:Nb crystals , <a href=\"https://doi.org/10.1088/0953-8984/19/11/116214\"><i>J. Phys.: Condens. Matter</i> <b>19</b>, 116214, 2007</a>",
...
},
{
   ...
   "formula": 2,
   "range": [0.4, 5],
   "references": "D. E. Zelmon, D. L. Small and R. Page. Refractive-index measurements of undoped yttrium aluminum garnet from 0.4 to 5.0 æm, <a href=\"https://doi.org/10.1364/AO.37.004933\"><i>Appl. Opt.</i> <b>37</b>, 4933-4935 (1998)</a>",
   "source": "Zelmon"
},
{
   "book": "YLiF4",
