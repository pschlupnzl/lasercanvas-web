...
window.LaserCanvas.Render = function (system, info, canvas) {
	...
	var
		...
		*/
		...
		////		context = getContext(),           // {CanvasRenderingContext2d} Rendering context.
		...
		////			if (abcdQ) {
		////				window.LaserCanvas.Render.renderMode(this, loc, {
		////					dist: loc.l,
		...
		////	window.LaserCanvas.Render.renderMode(this, loc, b, plane);
		////	var 
		////		LaserCanvas = window.LaserCanvas,
      ...
      ////   
		...
		////	beginPath();
		////	setStroke(LaserCanvas.theme.current.mode[plane], [1, 2][plane]);
		...
		////			
		////		// Draw this element.
		////		element.draw(this, layer);             // Draw current element.
		////		
		////		// Draw interval to next.
		////		if (nextElement !== null) {
		////			drawToNext.call(this, element, nextElement, layer); // Render space to next element.
		////		} else if (system.property('configuration') === LaserCanvas.System.configuration.ring) {
		////			drawToNext.call(this, element, elements[0], layer);
		////		}
		////	}
		////},
		...
		*/
		update = function () {
			...
			////clearCanvas();
			////updateLayer.call(this, renderLayer.axis);
			////updateLayer.call(this, renderLayer.tangential); // Tangential is in the plane of the table.
			////updateLayer.call(this, renderLayer.sagittal);   // Sagittal is vertical, out of plane.
			////updateLayer.call(this, renderLayer.optics);
			////
			////save();
			////getContext().font = '11pt "Open Sans",Helvetica,Arial,sans-serif';
			////if (mprop.showDistance) {
			////	updateLayer.call(this, renderLayer.distance);
			////}
			////if (mprop.showAnnotation) {
			////	updateLayer.call(this, renderLayer.annotation);
			////}
			////restore();
		};
